...
\pl\tt \verb|filenametemplate|&     \pageref{Dfilenametemplate}&
...
number of pixels according to PostScript conversion rules.  In \MF,
rules are not generated directly, but simply included in specials and
interpreted later by other programs, such as {\tt gftodvi}, so there is
