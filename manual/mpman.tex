...
merge them into a downloadable Type~3 PostScript font~\cite{ad:red}.
...
conversion rules.  In \MF, rules are not generated directly, but simply
included in specials and interpreted later by other programs, such as
{\tt gftodvi}\index{gftodvi?\ttt{gftodvi}}, so there is no special conversion.
...
\begin{minipage}[b]{.7\linewidth}\ttfamily
\begin{multicols}{3}
blackpart\\
bluepart\\
bounded\\
