...
endfig;
\end{verbatim}
\quad \mathcenter{\includegraphics{mpman-2}}
$$
...
\begin{figure}[htp]
$$ {\includegraphics{mpman-104} \atop (a)}
  \qquad {\includegraphics{mpman-204} \atop (b)}
$$
...
\begin{figure}[htp]
$$ \mathcenter{\includegraphics{mpman-7}} \quad
\begin{verbatim}
beginfig(7)
for a=0 upto 9:
...
\begin{figure}[htp]
$$ \mathcenter{\includegraphics{mpman-8}} \quad
\begin{verbatim}
beginfig(8)
for a=0 upto 7:
  draw (0,0){dir 45}..{dir 10a}(6cm,0);
...
\begin{figure}[htp]
$$ {\mathcenter{\includegraphics{mpman-109}} \atop
    \hbox{\verb|draw z0{up}..z1{right}..z2{down}|}}
  \quad
   {\mathcenter{\includegraphics{mpman-209}} \atop
    \hbox{\verb|draw z0{up}...z1{right}...z2{down}|}}
$$
...
\begin{figure}[htp]
$$ {\mathcenter{\includegraphics{mpman-110}} \atop (a)}
  \quad
   {\mathcenter{\includegraphics{mpman-210}} \atop (b)}
  \quad
   {\mathcenter{\includegraphics{mpman-310}} \atop (c)}
$$
...
\begin{figure}[htp]
$$ {\mathcenter{\includegraphics{mpman-111}} \atop c=0}
  \qquad
   {\mathcenter{\includegraphics{mpman-211}} \atop c=1}
  \qquad
   {\mathcenter{\includegraphics{mpman-311}} \atop c=2}
  \qquad
   {\mathcenter{\includegraphics{mpman-411}} \atop c=\infty}
$$
...
endfig;
\end{verbatim}
\quad \mathcenter{\includegraphics{mpman-13}}
$$
...
endfig;
\end{verbatim}
\qquad \mathcenter{\includegraphics{mpman-17}}
$$
...
endfig;
\end{verbatim}
\qquad \mathcenter{\includegraphics{mpman-18}}
$$
...
endfig;
\end{verbatim}
\qquad \mathcenter{\includegraphics{mpman-19}}
$$
...
Once the \TeX\ run is finished, MetaPost translates the resulting DVI
file into low level MetaPost commands that are then read instead of
the {\tt btex} \ldots\ {\tt etex} blocks.  If the main file is {\tt
fig.mp}, the translated \TeX\ material is placed in a file named {\tt
fig.mpx}\index{files!mpx?{\tt mpx}}.

The conversion normally runs silently without any user intervention
but it could fail, for instance if one of the {\tt btex} \ldots {\tt
etex} blocks contains an erroneous
\TeX\index{TeX?\TeX!errors} command.  In that case, the \TeX\ input is
saved in the file {\tt mpxerr.tex}\index{mpxerr.tex?\texttt{mpxerr.tex}}
and the \TeX\ error messages appear in {\tt
...
environment varabile \ttindex{MAKEMPX} is set, this external program 
will be executed instead of the internal code.
...
endfig;
\end{verbatim}
\qquad \mathcenter{\includegraphics{mpman-21}}
$$
...
endfig;
\end{verbatim}
\qquad \mathcenter{\includegraphics{mpman-22}}
$$
\caption{MetaPost code and the corresponding output.}
...
\begin{figure}[htp]
$$ {\includegraphics{mpman-123} \atop (a)}
 \qquad {\includegraphics{mpman-223} \atop (b)}
$$
...
endfig;
\end{verbatim}
\atop \mathcenter{\includegraphics{mpman-24}}
$$
\caption{MetaPost code and the corresponding output.}
\label{fig23}
\end{figure}
...
endfig;
\end{verbatim}
\quad \mathcenter{\includegraphics{mpman-28}}
$$
...
endfig;
\end{verbatim}
\quad \mathcenter{\includegraphics{mpman-32}}
$$
...
\end{verbatim}
\qquad
\mathcenter{\includegraphics{mpman-33}}
$$
\caption{MetaPost code and the corresponding output}
\label{fig33}
\end{figure}
...
\end{verbatim}
\qquad
\mathcenter{\includegraphics{mpman-34}}
$$
\caption{MetaPost code and the corresponding output}
\label{fig34}
\end{figure}
...
endfig;
\end{verbatim}
\quad \mathcenter{\includegraphics{mpman-38}}
$$
...
\end{verbatim}
\qquad
\mathcenter{\includegraphics{mpman-40}}
$$
...
endfig;
\end{verbatim}
\quad \mathcenter{\includegraphics{mpman-42}}
$$
...
endfig;
\end{verbatim}
\quad \mathcenter{\includegraphics{mpman-45}}
$$
\caption{MetaPost code and the corresponding figure}
\label{fig45}
\end{figure}
