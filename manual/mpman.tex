...
\subsection{Using MetaPost graphics in \TeX\ and \LaTeX}
\label{Dthirdparty}
...
font ressources and encoding vectors are not stored in the files.  For that
...
MetaPost files to \ttt{pdf}.}

However, with MetaPost version~1.000 the situation changed.  Since that version
MetaPost is able to produce self-contained EPS files.\footnote{As long as you're
...
doesn't know that extension by default.
\end{itemize}
