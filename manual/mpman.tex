...
operator (see Table~\ref{dfltcmod} on p.~\pageref{dfltcmod}).
The color of a picture component \ttt{p} is
...
Applying a non-matching color part operator to a picture component
triggers an error and returns a \ttindex{black} color part in the
requested color model.  That is, for the code
$$\begin{verbatim}
picture pic;
