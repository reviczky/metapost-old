\begin{longtable}{|>{\ttfamily}p{.8in}*{3}{|p{.7in}}|>{\raggedleft}p{.2in}|>{\raggedright\arraybackslash}X|}
...
bot&  --&  numeric\par pair&  numeric\par pair&  \pageref{Dbot}&  Bottom of current pen when centered at the given coordinate(s)\\\hline
\pl bounded&  --&  any&  boolean&  \pageref{Dbounded}&  Is argument a picture with a bounding box?\\\hline
...
\pl filled&  --&  any&  boolean&  \pageref{Dfilled}&  Is argument a filled outline?\\\hline
...
\pl readfrom&  --&  string&  string&  \pageref{Dreadfrom}&  Read a line from file\\\hline
...
\pl stroked&  --&  any&  boolean&  \pageref{Dstroked}&  Is argument a stroked line?\\\hline
...
\pl textual&  --&  any&  boolean&  \pageref{Dtextual}&  Is argument typeset text?\\\hline
