...
\begin{itemize}
  \item MetaObj\index{MetaObj},
  \item expressg\index{expressg}, and
  \item blockdraw\_mp\index{blockdraw\_mp}.
\end{itemize}
If you intend to create lots of technical graphics, you should have a
look at those packages, too.
